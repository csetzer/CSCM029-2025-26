...
public class Ledger extends UserAmount {
    ...
    /**
     *  Task 3.4: Fill in the method checkUserAmountDeductable
     ...
     *
     *  NOTE  processTransaction appears AFTER Task 3.5
     *
     *  This is essentially the same as Tasks 2.1 - 2.3 + Task 2.5 of lab 2
     **/
   ...
   /**
    ...
    /**
     * Task 3.4, last part. Fill in the method processTransaction
     *
	...
	/**
         ...
         *  you can use the above exampleSignature, when a sample signature
	 *     is needed
